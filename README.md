...
- 📝 **Advanced Text Changer Engine**:
  ...
  - **Fancy Font Normalization**: Automatically converts mathematical, script, and gothic unicode fonts (e.g. `𝙺𝙰𝙸𝙵`, `𝒦𝒜𝐼𝐹`, `🅺🅰🅸🅵`) for clean pattern matching.
...
- 🗄️ **Dual Session Persistence**: Supports **MongoDB** for cloud persistence and automatically falls back to **Local Multi-File Auth** if MongoDB is omitted.
...
git clone https://github.com/KaifxChaudhary-dev/Kaif-Md-V3.git
cd Kaif-Md-V3
